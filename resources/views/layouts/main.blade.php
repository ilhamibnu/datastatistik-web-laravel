...
<head>
    ...
    <title>@yield('title') - Adminmart Template</title>
    <!-- Custom CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('new-css/datatablesbutton.css') }}">
    <link rel="stylesheet" href="{{ asset('new-css/dataTables.bootstrap4.css') }}">
